...
(define tests
  (test-suite
   ...
   ;; call CHALLENGE test
   (check-equal? (eval-exp-c (call (fun-challenge #f "x" (add (var "x") (int 7)) (set)) (int 1))) (int 8) "call test")

   ;; call CHALLENGE test
   (check-equal? (eval-exp-c (call (closure '() (fun-challenge #f "x" (add (var "x") (int 7)) (set null))) (int 1))) (int 8) "call test")
   ...
   (eval-exp-c (call (call mupl-mapAddN (int 7))
                   (racketlist->mupllist 
                    (list (int 3) (int 4) (int 9)))))) (list (int 10) (int 11) (int 16)) "challenge test")
