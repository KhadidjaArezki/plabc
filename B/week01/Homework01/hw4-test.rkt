...
(define tests
  (test-suite
   ...
   ;(check-equal? (sequence 1 1 0)  (error "stride must be a positive number"))
   ...
   (check-equal? (string-append-map (list "dan" "dog") "")
                 (list "dan" "dog"))
...
;(define f (cached-assoc (list (cons 1 2) (cons 2 3) (cons 3 4) (cons 4 5)) 3))
;(f 5)
;(f 1)
;(f 2)
;(f 3)
...
;(vector-assoc 9 (vector (cons 2 1) (cons 3 1) (cons 4 1) (cons 5 1)))
;(stream-for-n-steps (cycle-lists (list 1 2 3) (list "a" "b")) 3)
;(stream-for-n-steps (cycle-lists (list 1 2 3) (list "a" "b")) 5)
;(stream-for-n-steps (stream-add-zero ones) 1)
;(stream-for-n-steps (stream-add-zero nats) 3)
...
;(list-nth-mod (list 1) 0)
;(list-nth-mod (list 1 2) 1)
;(string-append-map '() ".suffix")
;(string-append-map (list "dan" "dog") "")
